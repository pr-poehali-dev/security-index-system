...
- [x] Mock-объекты (КС-01, КС-02, ГРС-15, Склад НП-03)
...
### Этап 7: Интеграция с модулем Каталог (ПЛАНИРУЕТСЯ)

**Замена mock-объектов на реальные:**
- [ ] Загрузка объектов из базы данных
- [ ] Использование реального поля `required_competencies`
- [ ] Автоматическое определение требований по классу опасности

**Виджет на странице объекта:**
- [ ] Показывать список персонала с доступом
- [ ] Отображать статусы соответствия
- [ ] Быстрое назначение/отзыв доступа
...
🔗 **Интеграция с модулем Каталог** - реальные объекты, виджет на странице объекта
