...
## 🏢 Управление тенантами и организациями

### Для SuperAdmin
**Управление тенантами** (Раздел "Управление тенантами")
- Создание новых тенантов (организаций верхнего уровня)
- Назначение администратора тенанта
- Выбор доступных модулей для тенанта
- Установка срока действия лицензии

### Для TenantAdmin
**Настройки тенанта** (Раздел "Настройки")
Администратор тенанта имеет доступ к специальному модулю настроек с двумя вкладками:

#### 1. **Организации**
Управление дочерними организациями внутри тенанта:
- Добавление новых организаций
- Редактирование реквизитов (ИНН, КПП, адрес)
- Изменение статуса (активна/неактивна)
- Просмотр количества персонала в организации
- Удаление организаций (вместе с привязанным персоналом)

#### 2. **Персонал**
Управление пользователями системы:
- Добавление физических лиц с назначением ролей
- Доступные роли:
  - **Аудитор** - полный доступ к проверкам и инцидентам
  - **Менеджер** - работа с задачами и обслуживанием
  - **Директор** - доступ к аналитике и бюджету
- Привязка сотрудников к организациям
- Редактирование контактных данных (email, телефон)
- Изменение статуса (активен/неактивен)
- Удаление сотрудников

**Важно**: Только TenantAdmin может управлять организациями и персоналом внутри своего тенанта. SuperAdmin управляет только тенантами верхнего уровня.

## 🎯 Интерактивные формы редактирования

Система включает полнофункциональные диалоги редактирования для инцидентов и задач с возможностью смены статусов, добавления комментариев и отслеживания хронологии.
