  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {contractor?.id ? 'Редактировать подрядчика' : 'Добавить подрядчика'}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="ООО 'Подрядная компания'"
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="contractorExternalOrgId">Внешний ID</Label>
                <Input
                  id="contractorExternalOrgId"
                  {...register('contractorExternalOrgId')}
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <Label htmlFor="contractExpiryDate">Дата окончания</Label>
                <Input
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit">
              {contractor?.id ? 'Сохранить' : 'Добавить'}
            </Button>
          </div>
        </form>
      </DialogContent>
