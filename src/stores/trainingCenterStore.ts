...
export const useTrainingCenterStore = create<TrainingCenterState>()(persist((set, get) => ({
  ...
  groups: [
    {
      ...
      enrolledCount: 3,
      status: 'completed',
      notes: 'Группа для ООО "ЭнергоПром"',
      externalEnrollments: [
        {
          tenantId: 'tenant-1',
          tenantName: 'ООО "ЭнергоПром"',
  ...
  locations: [
    {
      ...
      capacity: 30,
      equipment: ['Проектор', 'Доска', 'Компьютеры'],
      status: 'active',
  ...
  issuedCertificates: [
    ...
    },
    {
      ...
      certificateFileUrl: '/files/certificates/cert-b11-12345.pdf',
      protocolFileUrl: '/files/protocols/protocol-b11-456.pdf',
      status: 'issued',
      issuedBy: 'Комиссия АНО ДПО "УЦ Профессионал"',
    ...
    },
    {
      ...
      category: 'industrial_safety',
      area: 'Б.1.1 Эксплуатация опасных производственных объектов',
      certificateFileUrl: '/files/certificates/cert-b11-12346.pdf',
      protocolFileUrl: '/files/protocols/protocol-b11-456.pdf',
      status: 'issued',
      issuedBy: 'Комиссия АНО ДПО "УЦ Профессионал"',
      createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      category: 'industrial_safety',
      area: 'Б.1.1 Эксплуатация опасных производственных объектов',
      certificateFileUrl: '/files/certificates/cert-b11-12347.pdf',
      protocolFileUrl: '/files/protocols/protocol-b11-456.pdf',
      status: 'issued',
      issuedBy: 'Комиссия АНО ДПО "УЦ Профессионал"',
      createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      groupId: 'group-002',
      programId: 'program-ot',
      programName: 'Охрана труда для руководителей',
      ...
      certificateFileUrl: '/files/certificates/cert-ot-45678.pdf',
      protocolFileUrl: '/files/protocols/protocol-ot-789.pdf',
      status: 'issued',
      issuedBy: 'Комиссия АНО ДПО "УЦ Профессионал"',
      createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
      updatedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString()
    },
    {
      ...
      category: 'labor_safety',
      area: 'Охрана труда для руководителей и специалистов',
      certificateFileUrl: '/files/certificates/cert-ot-45679.pdf',
      protocolFileUrl: '/files/protocols/protocol-ot-789.pdf',
      status: 'issued',
      issuedBy: 'Комиссия АНО ДПО "УЦ Профессионал"',
      createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
