...
const mockIncidents: Incident[] = [
  ...
  },
  {
    ...
    sourceId: 'src-2',
    directionId: 'dir-2',
    description: 'Просроченное предписание: Нарушение режима энергопотребления на объекте',
    correctiveAction: 'Установить автоматическую систему контроля энергопотребления',
    fundingTypeId: 'fund-1',
    categoryId: 'cat-1',
    ...
    daysLeft: -35,
    status: 'overdue',
    notes: 'Требует срочного внимания!',
  ...
  },
  {
    ...
    productionSiteId: 'site-2',
    reportDate: '2025-02-05',
    sourceId: 'src-1',
    directionId: 'dir-3',
    description: 'Срочно: Отсутствие первичных средств пожаротушения на участке №3',
    correctiveAction: 'Закупить и установить огнетушители согласно нормам',
    fundingTypeId: 'fund-2',
    categoryId: 'cat-3',
    subcategoryId: 'sub-3-1',
    responsiblePersonnelId: 'pers-3',
    plannedDate: '2025-10-13',
    completedDate: undefined,
    daysLeft: 3,
    status: 'awaiting',
    notes: 'Срок исполнения приближается',
  ...
  },
  {
    ...
    sourceId: 'src-2',
    directionId: 'dir-4',
    description: 'Критическое: Не проведено техническое обслуживание крана',
    correctiveAction: 'Провести внеплановое ТО, остановить эксплуатацию до устранения',
    fundingTypeId: 'fund-3',
    categoryId: 'cat-1',
